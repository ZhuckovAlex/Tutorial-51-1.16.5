...
public class ModFirewoodBoatItem extends BoatItem {
    private static final Predicate<Entity> field_219989_a = EntityPredicates.NOT_SPECTATING.and(Entity::canBeCollidedWith);
    private final String woodType;

    public ModFirewoodBoatItem(Properties p_i48526_2_, String woodType) {
    ...
    public ActionResult<ItemStack> onItemRightClick(World worldIn, PlayerEntity playerIn, Hand handIn) {
        ...
        if (raytraceresult.getType() == RayTraceResult.Type.MISS) {
            ...
            if (raytraceresult.getType() == RayTraceResult.Type.BLOCK) {
                ModFirewoodBoatEntity boatentity = new ModFirewoodBoatEntity(worldIn, raytraceresult.getHitVec().x,
