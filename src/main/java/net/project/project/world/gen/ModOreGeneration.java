...
public class ModOreGeneration{
        public static void generateOres(final BiomeLoadingEvent event) {
            spawnOreInSpecificBiome(Biomes.DESERT, OreType.REDIUM, event, Dimension.OVERWORLD.toString());
            spawnOreInAllBiomes(OreType.REDIUM, event, Dimension.THE_NETHER.toString());
        }
