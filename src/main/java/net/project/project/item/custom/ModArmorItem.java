...
import net.project.project.item.ModArmorMaterial;
...
public class ModArmorItem extends ArmorItem {
    ...
    private static final Map<IArmorMaterial, Effect> MATERIAL_TO_EFFECT_MAP =
            new ImmutableMap.Builder<IArmorMaterial, Effect>()
                    .put(ModArmorMaterial.TUTORIAL, Effects.LUCK)
                    .build();
    private static final Map<IArmorMaterial, Effect> MATERIAL_TO_EFFECT_MAP1 =
            new ImmutableMap.Builder<IArmorMaterial, Effect>()
                    .put(ModArmorMaterial.TUTORIAL, Effects.REGENERATION)
                    .build();
    ...
    private void evaluateArmorEffects(PlayerEntity player) {
        ...
        for (Map.Entry<IArmorMaterial, Effect> entry : MATERIAL_TO_EFFECT_MAP1.entrySet()) {
            IArmorMaterial mapArmorMaterial = entry.getKey();
            Effect mapStatusEffect = entry.getValue();
